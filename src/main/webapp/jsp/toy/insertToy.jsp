...
<body>
    ...
    <main id="Main_ContentNT" class="Container_NewToy">
        <form id="Content_NewToy" action="ToyController" method="POST" enctype="multipart/form-data">
                ...
                <div class="fieldsetNT_boxCTG">
                   ...
                   <%
					...
					%>				
                    	...
                    	<label for="category_NT1" class="categorysNT"><%= category.getCategoryName() %></label><br>
		  			<%
					}
					%>
			...
			<div class="details_NT">
	            ...
	            <textarea class="details_BoxNT" maxlength="1080" placeholder="Escreva os Detalhes do Brinquedo"
	             name="toy_details" id="details_NT"></textarea>
            </div>
